from flask import render_template, request,url_for,flash,Blueprint, redirect
...
def user_posts(username):
    ...
    blog_posts = BlogPost.query.filter_by(author=user).order_by(BlogPost.date.dec()).paginate(page=page,per_page=5)
